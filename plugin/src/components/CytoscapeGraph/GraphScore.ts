import { DecoratedGraphElements, DecoratedGraphNodeWrapper } from '@kiali/types';
...
function normalizeRanks(elements: Readonly<DecoratedGraphElements>): {
  normalizedElements: DecoratedGraphElements;
  upperBound: number;
} {

...
import TrafficPolicyContainer, { ConsistentHashType, TrafficPolicyState, UNSET } from './TrafficPolicy';
...
import { ConfigPreviewItem, IstioConfigPreview } from '../IstioConfigPreview/IstioConfigPreview';
